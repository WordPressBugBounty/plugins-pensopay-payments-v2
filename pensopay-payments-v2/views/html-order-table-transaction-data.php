...
<div class="woocommerce-pensopay-order-transaction-data">
    <table border="0" cellpadding="0" cellspacing="0" class="meta">
        ...
        <tr>
            <td><?php esc_attr_e( 'Order ID', Pensopay_Payments_V2_Gateway::TEXT_DOMAIN ) ?>:</td>
            <td><?php echo esc_attr( $transaction_order_id ) ?></td>
        </tr>
        <tr>
    ...
    <div class="tags">
        ...
        <?php if ( $is_subscription ): ?>
            <span class="tag is-subscription">
                <?php echo esc_attr_e( 'Sub', Pensopay_Payments_V2_Gateway::TEXT_DOMAIN ) ?>
            </span>
        <?php endif; ?>
